...
## Create the CSV file in the course Catalog.Schema.Volume#df.to_csv(f"/Volumes/{catalog_name}/{schema_name}/{volume_name}/employees2.csv", index=False)
####################################################################################

# COMMAND ----------

# Define la ruta al volumen
volume_path = f"/Volumes/{catalog_name}/{schema_name}/{volume_name}/track/"
